'use client';
import { Toast } from "@/src/components/Login/Toast";
import { useLoginHandler } from "@/src/features/auth/useLoginHandler";
import { FaLock } from "react-icons/fa";
import { FaEnvelope } from "react-icons/fa";
export default function LoginPage() {

  const { handleSubmit, email, setEmail, password, setPassword, toast, setToast } = useLoginHandler();
